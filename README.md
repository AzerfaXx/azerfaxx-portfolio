<div align="center">
    <a href="https://azerfaxx.vercel.app"><h1 align="center">AzerfaXx</h1></a>
...
```sh-session
git clone https://github.com/azerfaxx/azerfaxx.git
cd AzerfaXx
```


Create a `.env` file similar to [`.env.example`](https://github.com/azerfaxx/azerfaxx/blob/main/.env.example).

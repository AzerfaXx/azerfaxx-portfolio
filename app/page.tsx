...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (!spaceAudioRef.current) {
      ...
      spaceAudioRef.current.loop = true; // Boucle infinie une fois lancé
    }
    ...
    if (!hasLaunched) playIntro(); // Joue seulement si l'intro n'a pas encore été lancée
  ...
  }, [hasLaunched]); // Dépend de hasLaunched pour relancer l'intro si nécessaire

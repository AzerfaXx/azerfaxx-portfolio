...
// Initialisation de Redis à partir des variables d'environnement
...
export default async function ProjectsPage() {
	...
	// On essaie de récupérer les vues, mais on gère l'échec
	try {
		...
		// En cas d'erreur (ex: variables d'env manquantes), on log l'erreur
		// et on continue avec un objet `views` vide pour que la page se construise quand même.
		console.error("Failed to fetch page views from Redis:", e);
	}

	const featured = allProjects.find((project) => project.slug === "tasklife")!;
	const top2 = allProjects.find((project) => project.slug === "frigochef")!;
	const top3 = allProjects.find((project) => project.slug === "fitlife")!;
